package com.ucarweekly.usercenterapi.vo;
...
public class RestFulVO<T> {
    ...
    public RestFulVO(WeeklyUserCenterRetEnum postResultEnum, T data) {
        this.restCode = postResultEnum.getCode();
        this.restMsg = postResultEnum.getMsg();
        this.data = data;
    }

    public RestFulVO(WeeklyUserCenterRetEnum postResultEnum) {
        this.restCode = postResultEnum.getCode();
        this.restMsg = postResultEnum.getMsg();
    }
