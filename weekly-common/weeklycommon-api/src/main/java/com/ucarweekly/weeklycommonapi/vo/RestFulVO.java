package com.ucarweekly.weeklycommonapi.vo;
...
public class RestFulVO<T> {
    ...
    public RestFulVO(WeeklyCommonRetEnum postResultEnum, T data) {
        this.restCode = postResultEnum.getCode();
        this.restMsg = postResultEnum.getMsg();
        this.data = data;
    }

    public RestFulVO(WeeklyCommonRetEnum postResultEnum) {
        this.restCode = postResultEnum.getCode();
        this.restMsg = postResultEnum.getMsg();
    }
