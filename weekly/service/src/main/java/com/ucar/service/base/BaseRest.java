...
public class BaseRest<T> {
    ...
    public RestFulVO restSuccessByList(List<T> obj) {
        RestFulVO vo = setSystemCode(WeeklyRetEnum.SUCCESS.getCode());
        vo.setData(obj);
        return vo;
    }
    ...
    public RestFulVO restSimpleSuccess() {
        return setSystemCode(WeeklyRetEnum.SUCCESS.getCode());
    }
    ...
    public RestFulVO restSimpleFault() {
        return setSystemCode(WeeklyRetEnum.ERROR.getCode());
    }
    ...
    private RestFulVO setSystemCode(String systemCode) {
        ...
        vo.setRestMsg(WeeklyRetEnum.getMsgByCode(systemCode));
        return vo;
    }
}
