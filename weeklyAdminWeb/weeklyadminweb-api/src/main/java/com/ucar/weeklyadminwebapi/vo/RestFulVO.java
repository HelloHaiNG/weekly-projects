package com.ucar.weeklyadminwebapi.vo;
...
public class RestFulVO<T> {
    ...
    public RestFulVO(WeeklyAdminWebRetEnum postResultEnum, T data) {
        this.restCode = postResultEnum.getCode();
        this.restMsg = postResultEnum.getMsg();
        this.data = data;
    }

    public RestFulVO(WeeklyAdminWebRetEnum postResultEnum) {
        this.restCode = postResultEnum.getCode();
        this.restMsg = postResultEnum.getMsg();
    }
